...
\begin{itemize}
	...
	\item The system-to-be must present: temperature, Ph, pressure, dissolved oxygen, study status, and IP address.
	\item The system-to-be must update temperature, Ph, pressure, dissolved oxygen and local IP address, study status, every two seconds.
