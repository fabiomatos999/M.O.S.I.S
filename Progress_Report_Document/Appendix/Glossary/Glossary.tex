...
\begin{description}
        ...
        \item[Aspect Ratio] Ratio between the width and the height of a computer display.
        \item[Back End] Database management component
        \item[Burst] Multiple images captured in succession
        \item[CSS] Cascading Style Sheet
        \item[CPU] Central Processing Unit
        \item[Database] Robust storage medium for the long term storage of data.
	...
	\item[Pixel] Fundamental unit of an image, normally comprised of a red, green and blue elements
        \item[Relational] Relates data between tables of a databse
