# Form implementation generated from reading ui file '.\SaturationConfigurationMenu.ui'
#
...
class Ui_SaturationConfigurationMenu(object):
    def setupUi(self, SaturationConfigurationMenu):
        SaturationConfigurationMenu.setObjectName("SaturationConfigurationMenu")
        SaturationConfigurationMenu.setWindowModality(QtCore.Qt.WindowModality.WindowModal)
        SaturationConfigurationMenu.setEnabled(True)
        SaturationConfigurationMenu.resize(800, 480)
        ...
        SaturationConfigurationMenu.setPalette(palette)
        SaturationConfigurationMenu.setAutoFillBackground(False)
        self.CurrentSaturationLabel = QtWidgets.QLabel(parent=SaturationConfigurationMenu)
...
"")
        self.CurrentSaturationLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.CurrentSaturationLabel.setObjectName("CurrentSaturationLabel")
        self.horizontalSlider = QtWidgets.QSlider(parent=SaturationConfigurationMenu)
        ...
        self.label0.setGeometry(QtCore.QRect(-50, 290, 141, 51))
        font = QtGui.QFont()
        font.setPointSize(40)
        self.label0.setFont(font)
        self.label0.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label0.setObjectName("label0")
        self.label24 = QtWidgets.QLabel(parent=SaturationConfigurationMenu)
        self.label24.setGeometry(QtCore.QRect(670, 290, 141, 51))
        font = QtGui.QFont()
        font.setPointSize(40)
        ...
        self.retranslateUi(SaturationConfigurationMenu)
        QtCore.QMetaObject.connectSlotsByName(SaturationConfigurationMenu)
