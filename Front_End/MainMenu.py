...
if __name__ == "__main__":
    ...
    if sensorStatus.isWorking():
        ...
        tempSensorStatus = sensorStatus.isTemperatureWorking()
        phSensorStatus = sensorStatus.ispHWorking()
        pressureSensorStatus = sensorStatus.isPressureWorking()
        dissolvedOxygenStatus = sensorStatus.isDissolvedOxygenWorking()
