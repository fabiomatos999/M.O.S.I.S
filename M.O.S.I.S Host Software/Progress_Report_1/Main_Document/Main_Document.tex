...
\input{../host_ui_use_case.tex}
\input{../host_ui_communication_uc1.tex}
\input{../host_ui_communication_uc2.tex}
\input{../host_ui_communication_uc3.tex}
\input{../host_ui_communication_uc4.tex}
\input{../host_ui_communication_uc5.tex}
\input{../host_ui_communication_uc6.tex}
\end{document}
%%% Local Variables:
%%% mode: latex
%%% TeX-master: t
